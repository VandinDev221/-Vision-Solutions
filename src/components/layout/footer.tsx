...
export const Footer = () => {
  return (
    <footer className="bg-[#060910] border-t border-slate-800/80 text-slate-400 text-sm py-12 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="sm:col-span-2 md:col-span-3 space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2.5 text-xs">
              ...
              >
                ...
                <span className="font-mono text-[11px] sm:text-xs truncate">{SITE_CONTACT.displayEmail}</span>
              </a>
              <a
        ...
        {/* Bottom Sub-Bar */}
        <div className="pt-6 sm:pt-8 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-xs text-slate-500 font-mono">
