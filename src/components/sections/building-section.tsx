...
export const BuildingSection = () => {
  return (
    <section className="relative py-20 bg-[#090d16] border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {saasProducts.map((p) => (
            <Card key={p.id} className="p-5 bg-[#111726] border-slate-800 flex flex-col justify-between">
              <div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-800/60 flex items-center justify-between text-xs text-slate-400">
                ...
                <Link href="/produtos" className="hover:text-sky-400 transition-colors flex items-center gap-1 font-medium">
                  <span>Ver</span>
