  ...
  return (
    <section className="relative py-28 bg-[#090d16] border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Asymmetrical 2-Pillar Editorial Composition with 3D Tilt Interaction */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Pillar 1: Produtos SaaS */}
          <div className="lg:col-span-6">
            <TiltCard maxTilt={6} className="h-full">
              <div className="p-8 sm:p-10 rounded-2xl bg-[#0e1422] border border-slate-800/90 hover:border-sky-500/40 transition-all duration-300 flex flex-col justify-between space-y-8 h-full group">
          ...
          <div className="lg:col-span-6">
            <TiltCard maxTilt={6} className="h-full">
              <div className="p-8 sm:p-10 rounded-2xl bg-[#0e1422] border border-slate-800/90 hover:border-emerald-500/40 transition-all duration-300 flex flex-col justify-between space-y-8 h-full group">
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
