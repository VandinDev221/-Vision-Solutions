      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {coreSolutions.map((item, idx) => (
            ...
            >
              <Card
                className="p-6 flex flex-col justify-between bg-slate-950/80 border-slate-800 hover:border-slate-700 transition-all duration-200 group h-full"
              >
                <div>
                  <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 w-fit mb-5 group-hover:scale-105 transition-transform duration-200">
                ...
                <div className="mt-6 pt-4 border-t border-slate-800/60 flex items-center text-xs text-slate-400 group-hover:text-indigo-400 font-medium transition-colors duration-200">
