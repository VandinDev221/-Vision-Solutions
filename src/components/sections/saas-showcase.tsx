      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {saasProducts.map((product, idx) => (
            ...
            >
              <Card
                className="p-6 md:p-8 flex flex-col justify-between bg-slate-900/60 border-slate-800 hover:border-slate-700 transition-all duration-200 group h-full"
              >
                <div>
                  {/* Header: Icon, Category & Badge */}
                  <div className="flex items-center justify-between gap-4 mb-6">
                    <div className="flex items-center gap-3">
                      <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 group-hover:scale-105 transition-transform duration-200">
                  ...
                  {/* UI Dashboard Mockup Frame (Subtle Zoom on Hover 1 -> 1.02) */}
                  <div className="relative rounded-xl bg-slate-950 border border-slate-800/90 p-3 mb-6 overflow-hidden transition-transform duration-200 group-hover:scale-[1.015]">
